...
export default function Reports() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h1 className="text-2xl sm:text-3xl font-black text-[#002B99] tracking-tight">
          Relatorios e Analitico
        </h1>
        <p className="text-slate-500 mt-1 text-sm">
          Visualize o impacto e a distribuicao das doacoes por incentivo fiscal.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <KpiCard
          ...
          value={`${data.kpis.totalCollectedXlm.toLocaleString("pt-BR")} XLM`}
        />
        <KpiCard
          title="Doadores Ativos"
          value={data.kpis.activeDonors.toLocaleString("pt-BR")}
        />
        <KpiCard
          title="Projetos Financiados"
          value={data.kpis.fundedProjects.toLocaleString("pt-BR")}
        />
        <KpiCard
          title="Ticket Medio"
          value={`${data.kpis.avgTicketXlm.toLocaleString("pt-BR")} XLM`}
        />
      </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-[#002B99]">
                      {project.incentive}
                    </p>
                  </div>
                </div>
