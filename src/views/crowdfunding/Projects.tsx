      ...
      <header className="relative bg-[#002B99] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8 text-center sm:text-left">
          ...
          <p className="text-lg text-blue-100 font-medium opacity-90 uppercase tracking-widest leading-relaxed max-w-3xl">
            Apoie projetos que empoderam mulheres de comunidades perifericas
            atraves da educacao tecnologica.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-2xl p-8">
            ...
            <p className="text-rose-600 text-xs mt-2 break-all">{error}</p>
          </div>
        ) : filtered.length === 0 ? (
          <div className="bg-white border border-slate-100 rounded-2xl p-8 text-sm font-bold text-slate-500">
                      ...
                      <div className="flex justify-between items-end">
                        <div className="flex flex-col">
                          ...
                          <span className="font-black text-slate-900">
                            {Number(project.raisedXlm).toLocaleString("pt-BR")}{" "}
                            XLM
                          </span>
                        </div>
